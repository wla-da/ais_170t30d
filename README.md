...
ST-Link V2 (Pin)	Название	Направление	E32 170T30D (HC32L110)
1 (крайний со стороны разъёма)	TVCC / 3.3V	Вход	VCC (3.3V)
2	SWDIO	<-->	SWDIO (вероятно, P27)
3	GND	<-->	GND
4	SWCLK	-->	SWCLK (вероятно, P31)
9 (опционально)	NRST	-->	RESET / NRST
