...
1) Через [использование HcUnlock.exe](https://www.eevblog.com/forum/microcontrollers/hc32l110-complete-erase/msg5037478/#msg5037478):
```
...
```
2) Через стандартный [ISP прошивальщик (китайский)](https://www.eevblog.com/forum/microcontrollers/hc32l110-complete-erase/msg5040610/#msg5040610):
```
